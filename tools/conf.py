...
TESTS = [
    ...
    Test('project_detail', [T_20, T_40, T_80, T_160]),
    Test('project_detail_comments', [T_20, T_40, T_80, T_160]),
    Test('project_detail_documents', [T_20, T_40, T_80, T_160]),
    Test('project_detail_events', [T_20, T_40, T_80, T_160]),
    Test('project_detail_questionnaire', [T_20, T_40, T_80, T_160]),
    Test('project_detail_report', [T_20]),
    Test('project_detail_settings', [T_20, T_40, T_80, T_160]),
    Test('project_detail_versions', [T_20, T_40, T_80, T_160]),
    Test('project_importer_suggestion', [T_20, T_40, T_80, T_160]),
    Test('project_list', [T_20, T_40, T_80, T_160]),
    Test('project_tag_suggestion', [T_20, T_40, T_80, T_160]),
